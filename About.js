...
const About = ({navigation}) => {
  return (
     <View style={{justifyContent: 'center', alignItems: 'center', padding: 24, }}>
      ...
      <Text style={styles.textread}>Номер телефона:</Text>
      <Text style={styles.phonetext}>8(100)233-23-65</Text>
      ...
      <View>
         ...
         <Image style={styles.logo2} source={require('./assets/2.jpg')}/>
         <Text style={styles.text_forcont}>Неизвестен</Text>
         <Text style ={styles.text_phone2}>9(250)677-13-55</Text>
        <Pressable
        onPress={() => navigation.navigate('Профиль пользователя')}
